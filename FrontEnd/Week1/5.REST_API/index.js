...
// this gives the access on incoming form data sent through post method
// it parses form data and put it in req.body
...
// Converts the updated users array (which now includes the new user) into a JSON string, which is required for writing to a .json file.
...
// just want to put the updated data in json format -> it is the value  , don't want any replacer so passed null    , 2 is the space for indentation

// task 4 done able to edit users data
...
// splice method removal k kam ata hai isme kis index se aur kitna tak ka index ko delete karna hai paas karna padta hai

// task 5 done able to delete a user
